...
public class ThirdParty extends JavaPlugin {
	...
	class WSClient extends WebSocketClient {
		...
		public void onOpen(ServerHandshake handshakedata) {
			...
			this.send(gson.toJson(new TAuthServerPacket(cfg.getString("token"), version, instance.getServer().getName(), instance.getServer().getMotd(), instance.getServer().getPort(), instance.getServer().getMaxPlayers(), instance.getServer().getOnlinePlayers().size(), cfg.getBoolean("visible"), Material.valueOf(cfg.getString("icon")).name())));
		}
